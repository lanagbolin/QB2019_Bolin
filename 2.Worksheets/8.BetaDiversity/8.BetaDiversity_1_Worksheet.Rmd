...
# FIX THIS PART
bray.source <- vegdist(jelly.source$Count, method = "bray")
mean(jelly.source)
...
> Dissimilarity was highest in the source community (0.34), so FIX THIS PART
...
jellyA.ward <- hclust(bray.A, method = "ward.D2")
jellyB.ward <- hclust(bray.B, method = "ward.D2")

par(mar = c(1, 5, 2, 2) + 0.1)
plot(jellyA.ward, 
     main = "Jelly Bean subcommunity A: Ward's Clustering",
     ylab = "Squared Bray-Curtis Distance")

plot(jellyB.ward, 
     main = "Jelly Bean subcommunity B: Ward's Clustering",
     ylab = "Squared Bray-Curtis Distance")
